...
load sae1OptTheta;
figure(1);
W1 = reshape(sae1OptTheta(1:hiddenSize*visibleSize), hiddenSize, visibleSize);
display_network(W1'); 
...
load sae2OptTheta;
% figure(2);
% W1 = reshape(sae2OptTheta(1:hiddenSize*visibleSize), hiddenSize, visibleSize);
% display_network(W1'); 
...
inputData = sae2Features;
labels = trainLabels;
options.maxIter = 100;
% softmaxModel = softmaxTrain(visibleSize, numClasses, lambda, inputData, labels, options);
